...
exports.ChroniclesModule = void 0;
const common_1 = require("@nestjs/common");
const chronicles_service_1 = require("./chronicles.service");
const chronicles_controller_1 = require("./chronicles.controller");
let ChroniclesModule = class ChroniclesModule {
};
exports.ChroniclesModule = ChroniclesModule;
exports.ChroniclesModule = ChroniclesModule = __decorate([
    (0, common_1.Module)({
